...
//set background circle color to most dominant color in image

circles = document.getElementsByClassName('circle-bg')
profilePics = document.getElementsByClassName('profile-picture')
